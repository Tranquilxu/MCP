...
def parse_args():
    ...
    parser.add_argument("--output-dir", type=str, default="./outputs_cocoop")
    parser.add_argument("--batch-size", type=int, default=4)
    parser.add_argument("--num-workers", type=int, default=0)
    parser.add_argument("--epochs", type=int, default=10)
    # number of context vectors
    parser.add_argument("--n-ctx", type=int, default=16) #4
...
def get_datasets(args):
    ...
    labeled_loader = DataLoader(labeled_dataset, batch_size=1, shuffle=True, num_workers=args.num_workers)
...
if __name__ == "__main__":
    ...
    for epoch in range(args.epochs):
        ...
        if top1[0] >= best_top1:
            best_top1 = top1[0]
            save_obj = {
                'CoCoOp_prompt_learner': model.prompt_learner.state_dict(),
                'epoch': epoch,
                'best_top1': best_top1,
                'top5': top5[0],
                'seed': args.seed
